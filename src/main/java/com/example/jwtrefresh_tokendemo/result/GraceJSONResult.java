...
/**
 * 自定义响应数据结构
 * 前端接受此类数据（json object)，根据业务去实现相关功能
 */
public class GraceJSONResult {
     ...
     * @return
     */
    public static GraceJSONResult freshMsg(Object object) {
        return new GraceJSONResult(ResponseStatusEnum.TOKEN_REFRESH, object);
    }
