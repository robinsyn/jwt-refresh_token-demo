package com.example.jwtrefresh_tokendemo.result;
...
public enum ResponseStatusEnum {
    ...
    TOKEN_SIGNER(106, false, "token签名器异常"),
    TOKEN_PARSE(105, false, "token解析异常"),
    TOKEN_EXP(103, false, "token已过期,请重新登录"),
    TOKEN_REFRESH(104, false, "请刷新token"),
    TOKEN_ERROR(102, false, "token不合法"),
